    ...
    <div ref={containerRef} className="relative w-full">
      <form onSubmit={handleSubmit} className="relative">
        <div className="pointer-events-none absolute inset-y-0 left-4 flex items-center">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="text-[#ffffff]">
        ...
        <input
          ...
          className="w-full rounded-xl border border-[#1a1a1a] bg-[#0a0a0a] py-3 pl-11 pr-24 text-sm text-[#f0f0f0] placeholder:text-[#888888] focus:border-[#ffffff] focus:outline-none focus:ring-1 focus:ring-[#ffffff]/30"
        />
        <button
          type="submit"
      ...
      {open && (
        <div className="absolute z-50 mt-1 w-full overflow-hidden rounded-xl border border-[#1a1a1a] bg-[#0a0a0a] shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
          {input.length < 2 ? (
            <div className="p-3">
              <p className="mb-2 px-1 text-[10px] uppercase tracking-[0.2em] text-[#999999]">Quick concepts</p>
